...
class DataLoader:
    ...
    def load_data(self, new_id):
        self.id = new_id
        self.image_path = self.file_path + "radar/"+ str(self.timestamp[self.id]) + '.png'
        self.mask_path = self.file_path + "mask/"+ str(self.timestamp[self.id]) + '.png'
...
if __name__ == "__main__":
    ...
    data_root = '/media/ee904/data/oxford/2019-01-10-11-46-21-radar-oxford-10k/RaMNet_data/'
